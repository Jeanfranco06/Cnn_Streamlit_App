...
class EmotionDataLoader:
    ...
    def preprocess_data(self, test_size=0.2, validation_split=0.1, max_samples=None):
        """Cargar y preprocesar imágenes reales de los directorios data/train/ y data/test/"""
        print("Cargando imágenes reales de emociones de data/train/ y data/test/...")
        ...
        for base_dir in data_dirs:
            ...
            print(f"Procesando directorio: {base_dir}")
