...
class EmotionClassifier:
    ...
    def _create_basic_model(self, filters=[32, 64], dropout_rate=0.25, learning_rate=1e-4):
        """Crear modelo básico para reconocimiento de emociones"""
        model = Sequential()
    ...
    def predict(self, image):
        ...
        try:
            ...
            # Verificar si el modelo necesita inicialización de métricas
            if not hasattr(self.model, 'compiled_metrics') or len(self.model.compiled_metrics) == 0:
                # Hacer una predicción dummy para construir métricas
