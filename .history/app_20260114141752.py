...
def show_evaluation_section(data_loader, data, dataset_name):
    ...
    # Forzar actualización de la página para evitar contenido residual
    if f'{dataset_name.lower()}_eval_force_update' not in st.session_state:
        st.session_state[f'{dataset_name.lower()}_eval_force_update'] = True
        st.rerun()
