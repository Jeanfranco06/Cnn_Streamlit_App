...
def load_emotion_data():
    ...
    try:
        ...
        if info['total_samples'] > 0:
            if 'real_images' in st.session_state and st.session_state['real_images']:
                st.info(f"✅ Usando {info['total_samples']} imágenes reales de rostros para el entrenamiento")
            else:
                st.warning(f"⚠️ Usando {info['total_samples']} imágenes sintéticas. Para mejores resultados, descarga datasets reales de emociones.")
